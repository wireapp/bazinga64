describe('Compliance', function() {
  ...
  describe('decode Base64', function() {
    ...
    it('is compliant with libsodium on long sequences', function() {
      ...
      var decodedWithBazinga64 = bazinga64.Decoder.fromBase64(encoded, false).asBytes;
      var decodedWithSodium = sodium.from_base64(encoded);

      console.log('A', decodedWithBazinga64);
      console.log('B', decodedWithSodium);

      expect(decodedWithBazinga64.length).toBe(decodedWithSodium.length);
    });
